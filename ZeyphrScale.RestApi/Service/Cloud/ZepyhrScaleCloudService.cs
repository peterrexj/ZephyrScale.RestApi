...
using ZeyphrScale.RestApi.Dtos.Cloud;
using Environment = ZeyphrScale.RestApi.Dtos.Cloud.Environment;

namespace ZeyphrScale.RestApi.Service.Cloud
{
    public class ZepyhrScaleCloudService : ZephyrScaleCloudServiceBase, IZepyhrScaleCloudService
    {
        /// <summary>
        /// Initialize the Zeyphr service with required parameters
        /// </summary>
        /// <param name="appUrl">Zeyphr endpoint, for example: https://app.tm4j.smartbear.com</param>
        /// <param name="passwordAuthKey">API token used to connect the service</param>
        /// <param name="restApiVersion">Rest API version for the Zeyphr Service (default value: 'v2')</param>
        ...
        public ZepyhrScaleCloudService(string appUrl,
            ...
            HttpStatusCode[] listOfResponseCodeOnFailureToRetry = null)
                : base(appUrl, passwordAuthKey, restApiVersion, folderSeparator, logPrefix, pageSizeSearchResult,
        ...
        public TestCase TestCaseCreate(TestCaseCreateRequest request)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testcases")
               .SetJsonBody(request)
        ...
        public TestCase TestCaseUpdate(TestCase request)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testcases/{request.Key}")
                .SetJsonBody(request)
        ...
        public TestCase TestCaseGetById(string testCaseKey)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testcases/{testCaseKey}")
        ...
        public Links TestCaseLinksGet(string testCaseKey)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testcases/{testCaseKey}/links")
               .GetWithRetry(assertOk: AssertResponseStatusOk,
                   timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                   retryOption: RequestRetryTimes,
                   httpStatusCodes: ListOfResponseCodeOnFailureToRetry);
        ...
        public void TestCaseLinkCreate(string testCaseKey, long issueId)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testcases/{testCaseKey}/links/issues")
                .SetJsonBody(body)
                .PostWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
        ...
        public Folder FolderGetById(string folderId)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/folders/{folderId}")
               .GetWithRetry(assertOk: AssertResponseStatusOk,
                   timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                   retryOption: RequestRetryTimes,
                   httpStatusCodes: ListOfResponseCodeOnFailureToRetry);
        ...
        public Folder FolderCreate(FolderCreateRequest request)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/folders")
                .SetJsonBody(request)
                .PostWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
        ...
        public TestCycle TestCycleCreate(TestCycleCreateRequest request)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testcycles")
                .SetJsonBody(request)
                .PostWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
        ...
        public TestCycle TestCycleGet(string testCycleIdOrKey)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testcycles/{testCycleIdOrKey}")
              .GetWithRetry(assertOk: AssertResponseStatusOk,
                  timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                  retryOption: RequestRetryTimes,
                  httpStatusCodes: ListOfResponseCodeOnFailureToRetry);
        ...
        public TestCycle TestCycleUpdate(TestCycle request)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testcycles/{request.Key}")
                .SetJsonBody(request)
                .PutWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
        ...
        public Links TestCycleLinksGet(string testCycleIdOrKey)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testcycles/{testCycleIdOrKey}/links")
                .GetWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
                    httpStatusCodes: ListOfResponseCodeOnFailureToRetry);
        ...
        public void TestCycleLinkCreate(string testCycleIdOrKey, Int64 issueId)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testcycles/{testCycleIdOrKey}/links/issues")
                .SetJsonBody(body)
                .PostWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
        ...
        public void TestExecutionCreate(TestExecutionCreateRequest request)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testexecutions")
                .SetJsonBody(request)
                .PostWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
        ...
        public TestExecution TestExecutionGet(string testExecutionIdOrKey, bool includeStepLinks = false)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/testexecutions/{testExecutionIdOrKey}")
                .GetWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
                    httpStatusCodes: ListOfResponseCodeOnFailureToRetry);
        ...
        public Status StatusGet(string statusId)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/statuses/{statusId}")
                .GetWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
                    httpStatusCodes: ListOfResponseCodeOnFailureToRetry);
        ...
        protected Pagination<Status> StatusesGet(IDictionary<string, string> request)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/statuses")
                .SetQueryParams(request)
                .GetWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
        ...
        protected Pagination<Environment> EnvironmentsGet(IDictionary<string, string> request)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/environments")
                .SetQueryParams(request)
                .GetWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
        ...
        public Environment EnvironmentGet(string environmentId)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/environments/{environmentId}")
                .GetWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
                    httpStatusCodes: ListOfResponseCodeOnFailureToRetry);
        ...
        public Project ProjectGet(string projectIdOrKey)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/projects/{projectIdOrKey}")
                .GetWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
                    httpStatusCodes: ListOfResponseCodeOnFailureToRetry);
        ...
        protected Pagination<Project> ProjectsGet(IDictionary<string, string> request)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/projects")
                .SetQueryParams(request)
                .GetWithRetry(assertOk: AssertResponseStatusOk,
                    timeToSleepBetweenRetryInMilliseconds: TimeToSleepBetweenRetryInMilliseconds,
                    retryOption: RequestRetryTimes,
        ...
        public void LinkDelete(string linkId)
        {
            ...
            var response = OpenRequest($"/{ZeyphrApiVersion}/links/{linkId}").Delete();
