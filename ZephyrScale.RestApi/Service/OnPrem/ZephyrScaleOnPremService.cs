...
namespace ZephyrScale.RestApi.Service.OnPrem
{
    public class ZephyrScaleOnPremService : ZephyrScaleOnPremServiceBase, IZephyrScaleOnPremService
    {
        ...
        /// </summary>
        /// <param name="appUrl">Zephyr endpoint</param>
        /// <param name="serviceUsername">Username for connecting to Zephyr</param>
        /// <param name="servicePassword">Password for connecting to Zephyr</param>
        /// <param name="zephyrApiVersion">Zephyr Scale Api version (default value 1.0)</param>
        /// <param name="jiraApiVersion">Jira Api version where the Zephyr is hosted (default value: 2)</param>
        ...
        public ZephyrScaleOnPremService(string appUrl,
            ...
            string proxyKeyName = "")
                : base(appUrl, serviceUsername, servicePassword, zephyrApiVersion, jiraApiVersion, 
                    ...
                    requestTimeoutInSeconds, retryOnRequestTimeout, proxyKeyName)
        { }
        ...
        public IList<TestCase> TestCaseByTestCaseName(string projectKey, string testCaseName,
            ...
            string fields = TestCaseDefaultFields) 
            => TestCaseByJql($"projectKey = \"{projectKey}\" AND name = \"{testCaseName}\"", predicate, breakSearchOnFirstConditionValid, fields);
        ...
        /// <param name="fields"></param>
        /// <returns></returns>
        public IList<TestCase> TestCaseByJql(string jql, Func<TestCase, bool> predicate = null,
            bool breakSearchOnFirstConditionValid = true, string fields = TestCaseDefaultFields)
        {
            Log($"Request to get the test cases by Jql [{jql}]");

            return SearchFull<TestCase>(new Dictionary<string, string> { { "query", jql }, { "fields", fields } },
        ...
        /// <param name="fields"></param>
        /// <returns></returns>
        public IList<TestCase> TestCaseIssueLinks(string issueKey, string fields = "key,name,folder,status,priority,component,owner,estimatedTime,labels,issueLinks")
        {
